# Native oracle: PathTracer over the UNMODIFIED upstream sphere_array.pyscene.
from falcor import *
import os
...
m.loadScene(os.path.join(media, "sphere_array.pyscene"))
...
m.frameCapture.baseFilename = "oracle-spherearray"
