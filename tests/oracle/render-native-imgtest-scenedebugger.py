# Native oracle: the UNMODIFIED upstream SceneDebugger.py image-test graph
# over cornell_box.pyscene (1 frame; FaceNormal mode is deterministic).
from falcor import *
import os
...
m.frameCapture.baseFilename = "oracle-imgtest-scenedebugger"
