# Native oracle: PathTracer over the UNMODIFIED upstream cornell_box.pyscene.
from falcor import *
import os
...
m.loadScene(os.path.join(media, "cornell_box.pyscene"))
...
m.frameCapture.baseFilename = "oracle-cornell"
