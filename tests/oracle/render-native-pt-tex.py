# Native oracle: VBufferRT -> MinimalPathTracer over oracle-pt-tex.pyscene.
from falcor import *
import os
...
m.loadScene(os.path.join(base, "assets/oracle-pt-tex.pyscene"))
...
m.frameCapture.baseFilename = "oracle-pt-tex"
