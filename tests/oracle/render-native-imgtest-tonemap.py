# Native oracle: the UNMODIFIED upstream ToneMapping.py image-test graph
# (ImageLoader -> ToneMapper -> BlitPass; no scene).
from falcor import *
import os
...
m.frameCapture.baseFilename = "oracle-imgtest-tonemap"
