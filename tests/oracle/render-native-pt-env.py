# Native oracle: VBufferRT -> MinimalPathTracer over oracle-pt-env.pyscene.
from falcor import *
import os
...
m.loadScene(os.path.join(base, "assets/oracle-pt-env.pyscene"))
...
m.frameCapture.baseFilename = "oracle-pt-env"
