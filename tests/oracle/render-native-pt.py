# Native oracle: VBufferRT -> MinimalPathTracer over oracle-pt.pyscene.
from falcor import *
import os
...
m.loadScene(os.path.join(base, "assets/oracle-pt.pyscene"))
...
m.frameCapture.baseFilename = "oracle-pt"
