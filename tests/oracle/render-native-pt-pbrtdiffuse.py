# Native oracle: VBufferRT -> MinimalPathTracer over oracle-pt-pbrtdiffuse.pyscene.
from falcor import *
import os
...
m.loadScene(os.path.join(base, "assets/oracle-pt-pbrtdiffuse.pyscene"))
...
m.frameCapture.baseFilename = "oracle-pt-pbrtdiffuse"
