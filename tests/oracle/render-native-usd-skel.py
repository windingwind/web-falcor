# Native oracle: UsdSkel skinning (assets/usd-skel.pyscene), captured through
# GBufferRT at 0.5s, 1.25s and 2.5s (looped). The scene
...
m.frameCapture.baseFilename = "usd-skel"
for frame in [12, 30, 60]:
    m.loadScene(os.path.join(base, "assets/usd-skel.pyscene"))
