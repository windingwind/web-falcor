# Native oracle: a curve vertex cache (assets/usd-curves-anim.pyscene), captured
# through GBufferRT at 0.25s, 1.0s and 2.0s. The scene
...
m.frameCapture.baseFilename = "usd-curves-anim"
for frame in [6, 24, 48]:
    m.loadScene(os.path.join(base, "assets/usd-curves-anim.pyscene"))
