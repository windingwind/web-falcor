# Native oracle: PathTracer with LightBVH over the multi-cluster emissive scene.
from falcor import *
import os

base = os.path.dirname(os.path.abspath(__file__))

g = RenderGraph("OracleBVHCluster")
...
m.loadScene(os.path.join(base, "assets/oracle-pt-bvhcluster.pyscene"))
m.scene.camera.position = float3(3.0, 3.5, 7.0)
m.scene.camera.target = float3(3.0, 0.5, 0.0)
...
m.frameCapture.baseFilename = "oracle-fullpt-bvhcluster"
