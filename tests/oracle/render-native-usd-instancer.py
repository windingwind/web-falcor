# Native oracle: a UsdGeomPointInstancer (assets/usd-instancer.pyscene) through
# GBufferRT hit mask, world positions and normals.
from falcor import *
import os
...
m.loadScene(os.path.join(base, "assets/usd-instancer.pyscene"))
...
m.frameCapture.baseFilename = "usd-instancer"
m.renderFrame()
