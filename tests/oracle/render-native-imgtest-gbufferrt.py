# Native oracle: the UNMODIFIED upstream GBufferRTInline.py image-test graph
...
exec(open(os.path.join(root, "tests/image_tests/renderpasses/graphs/GBufferRTInline.py")).read())
...
m.frameCapture.baseFilename = "oracle-imgtest-gbufferrt"
