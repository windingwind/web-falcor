/**
 * DOM implementation of UIWidgets (native Gui::Widgets): retained-mode controls appended
 * to a container; changing one runs its callback, then `notify` (e.g. to rebuild the panel
 * or reset accumulation). Styled through the ui-row/ui-text classes.
 */
import type { UIWidgets } from "../../RenderGraph/UIWidgets.js";

export class DomWidgets implements UIWidgets {
    constructor(
